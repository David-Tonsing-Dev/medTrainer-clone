...
import { Command, Printer, FileText } from "react-feather";
  ...
  return (
    <>
      ...
      <CCard className="mb-4">
        <CCardBody>
          <AppHeaderSecondary title="Course Assignments" />
          <CRow>
            <CAccordion>
              <CAccordionItem>
                ...
                <CAccordionBody>
                  <CRow xs={{ gutter: 4 }}>
                    ...
                    <CCol sm={12} xl={4} xxl={3}>
                      <CDropdown className="cmr2 w-100">
                        ...
                        <CDropdownMenu className="w-100">
                          <CDropdownItem href="#">Admin</CDropdownItem>
                          <CDropdownItem href="#">Studnet</CDropdownItem>
                        </CDropdownMenu>
                      </CDropdown>
                    </CCol>
                    <CCol sm={12} xl={4} xxl={3}>
                  ...
                  <CRow className="justify-content-center cmt2">
                    <CCol sm={12} xl={4} xxl={3}>
                      <CButton
                        component="a"
                        color="info"
